...
#ifndef _EXAMPLE_CPP_TRAIN_HOG_H_
#define _EXAMPLE_CPP_TRAIN_HOG_H_
...
typedef std::set<FFR_UTIL::Feature> FeaturesSet;

//! to avoid feature-result mismatch issue, we use a pair
typedef std::pair<FFR_UTIL::Feature, std::string> ResultPair;
...
static int execute(int argc, char **argv) {
  ...
  //-- if test models on a single image flowPFF
...
#endif /* _EXAMPLE_CPP_TRAIN_HOG_H_ */
